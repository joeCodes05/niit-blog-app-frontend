...
const PostCard = ({ title, detail, profileImage, userName, coverPhoto, topic, postTime, path }) => {
  return (
    <>
        ...
        <div className='py-5 px-3 rounded-2xl ring-1 ring-gray-700 bg-secondary text-white'>
          <button className="flex gap-2 items-center bg-transparent outline-none">
            ...
            <div>
              ...
              <h5 className='text-gray-400 text-sm text-left italic'>{postTime}</h5>
            </div>
          </button>
          ...
          <div className="mt-3">
            <div className="rounded-xl ring-1 ring-gray-700 p-2">
              <p className='text-gray-400 text-sm post_card_text'>
                {detail}
              </p>

              <div className="mt-2 h-[150px] relative overflow-hidden w-full">
                <div className="bg-dark text-gray-400 absolute text-[.7rem] top-0 right-0 m-2 opacity-0 duration-500 group-hover:opacity-100 rounded-md py-[2px] px-2 shadow">
                  {topic}
                </div>
